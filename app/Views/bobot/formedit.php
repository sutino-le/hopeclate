...
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <?= form_open_multipart(base_url() . 'updatebobot', 'class="formupdate"'); ?>
    <?= csrf_field(); ?>
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="bobotid" value="<?= $bobotid ?>">
            <input type="text" class="form-control" name="jenis" id="jenis" value="<?= $jenis ?>" placeholder="Jenis" autocomplete="off">
            <div class="invalid-feedback errorJenis"></div>
        </div>
        <div class="form-group">
            <label for="nilai">Nilai</label>
            <input type="number" class="form-control" name="nilai" id="nilai" value="<?= $nilai ?>" placeholder="Nilai" autocomplete="off">

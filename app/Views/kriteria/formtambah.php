...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title"><a href="<?= base_url() ?>kriteria" class="btn btn-sm btn-warning"><i class="fas fa-arrow-alt-circle-left"></i>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="kriteria" id="kriteria" placeholder="Kriteria" autocomplete="off">
